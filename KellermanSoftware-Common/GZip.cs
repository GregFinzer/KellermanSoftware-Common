...
namespace KellermanSoftware.Common
{
    public class GZip
    {
        ...
        public bool DecompressFile(string sDir, GZipStream zipStream, ProgressDelegate progress)
        {
        ...
        public void DecompressToDirectory(string sCompressedFile, string sDir, ProgressDelegate progress)
        {
        ...
        public void DecompressToDirectory(Stream compressedStream, string sDir, ProgressDelegate progress)
        {
